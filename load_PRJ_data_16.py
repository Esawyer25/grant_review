...
from CapApp.models import Grant, Keyword, Grant_Publication
...
zip_files = ['seed_data/zipfiles_PRJ/RePORTER_PRJ_C_FY2016.zip', 'seed_data/zipfiles_PRJ/RePORTER_PRJ_C_FY2015.zip', 'seed_data/zipfiles_PRJ/RePORTER_PRJ_C_FY2014.zip']
...
groups= ['B','C', 'G', 'H', 'L', 'O', 'P', 'T', 'U', 'V', 'I', 'M', 'N', 'X', 'Y', 'Z']
...
zip_files = [
'seed_data/zipfiles_PRJ_ABS/RePORTER_PRJABS_C_FY2016.zip','seed_data/zipfiles_PRJ_ABS/RePORTER_PRJABS_C_FY2015.zip','seed_data/zipfiles_PRJ_ABS/RePORTER_PRJABS_C_FY2014.zip'
]
